...
// I'm using military time without a ':' because I wanted to visualize this as a number instead of a string.
const firstTicket = new Ticket('pizza, bread, soda', 1903, 575);
